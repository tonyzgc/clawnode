...
- **Weight**: ~120g
- **Material**: CNC aluminum unibody, anodized finish
- **Connection**: USB-C 2.0 (1.5m L-shaped cable)
...
- **Status Lighting**: Minimal LED indicators (standby dim blue, active white glow)
